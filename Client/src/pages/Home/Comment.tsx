...
const img1 = "https://ik.imagekit.io/lnl0n5gl6/assets/4.png";
const bgimg =
  "https://ik.imagekit.io/lnl0n5gl6/assets/lastBanner.png";
...
const Comment = () => {
  ...
  return (
    <div
      className="w-full bg-cover bg-black bg-center text-white"
      style={{
      ...
      <div className="bg-black/50 w-full h-full md:px-16 py-20 px-6">
        <div className="max-w-5xl mx-auto text-center ">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-10 transition-all duration-500 ease-in-out">
            ...
            {/* Text with animation */}
            <div
              className={`max-w-xl text-left transition-opacity duration-500 ${
