...
const banner = "https://ik.imagekit.io/lnl0n5gl6/assets/banner-6.png";
const blogImg1 = "https://ik.imagekit.io/lnl0n5gl6/assets/blog-1.png";
const blogImg2 = "https://ik.imagekit.io/lnl0n5gl6/assets/chwanprash.png";
const blogImg3 = "https://ik.imagekit.io/lnl0n5gl6/assets/dried-2.png";
const blogImg4 = "https://ik.imagekit.io/lnl0n5gl6/assets/juices.png";
const blogImg5 = "https://ik.imagekit.io/lnl0n5gl6/assets/small-peices.jpg";
...
export default function Blogs() {
  const [blogs, setBlogs] = useState<typeof dummyBlogs>([] as unknown as typeof dummyBlogs);
  ...
  useEffect(() => {
    ...
    setBlogs(dummyBlogs.slice(start, end) as typeof dummyBlogs);
  }, [page]);
  ...
  return (
    <section className="bg-white">
      ...
      {/* Banner */}
      <div
        className="relative  h-[300px] md:h-[500px] bg-cover bg-center bg-no-repeat flex items-center justify-center text-white"
        style={{
