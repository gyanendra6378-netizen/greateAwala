...
const imgOfTree = "https://ik.imagekit.io/lnl0n5gl6/assets/tree-4.png";
const imgJuice = "https://ik.imagekit.io/lnl0n5gl6/assets/juices.png";
const imgPawder = "https://ik.imagekit.io/lnl0n5gl6/assets/driy-1.jpg";
const sempu = "https://ik.imagekit.io/lnl0n5gl6/assets/sempu.png";
const driedFood = "https://ik.imagekit.io/lnl0n5gl6/assets/dried-2.png";
const oil = "https://ik.imagekit.io/lnl0n5gl6/assets/oli-1.png";
...
const articlesData = [
  {
    ...
    likes: 320,
    content:
      "Yeh article detail mein bataata hai ki fresh amla kaise immunity aur health improve karta hai...",
  },
  {
    id: 2,
    ...
    likes: 450,
    content:
      "Great Awala Chyawanprash ek herbal tonic hai jo immunity ko boost karta hai...",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    likes: 210,
    content:
      "Daily use ke liye Great Awala products lifestyle improve karte hain...",
  },
  {
    id: 5,
    ...
    likes: 345,
    content:
      "Great Awala ke products natural aur trusted quality ke saath aate hain...",
  },
  {
    id: 6,
    ...
    likes: 410,
    content:
      "Farm se jar tak ka safar jo Great Awala ko unique banata hai...",
  },
] as const;
    ...
    setArticles((prev) =>
      prev.map((article) =>
        article.id === id
          ? {
              ...article,
              likes: liked[id] ? article.likes - 1 : article.likes + 1,
            }
          : article
      )
    );
              ...
              <div className="flex items-center text-sm text-gray-600 gap-4 mb-2">
                ...
                >
                  <Heart
                    size={14}
                    className={
                      liked[article.id] ? "text-red-500 fill-red-500" : ""
                    }
                  />{" "}
                  {article.likes}
                </button>
