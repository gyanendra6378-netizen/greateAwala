...
export default function BlogDetail() {
  ...
  // Get blog from location state or find by id
  const blog = location.state?.blog || dummyBlogs.find((b) => b.id === parseInt(id));
          ...
          >
            ...
            <div className="text-gray-700 leading-relaxed space-y-6 text-lg">
              ...
              <div className="bg-gradient-to-r from-[#fef8f4] to-white rounded-xl p-6 border border-[#d89a7e]/20 mt-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Incorporating Amla into your daily routine is one of the best decisions you can make for your health. 
                  With its powerful nutritional profile and proven health benefits, Amla stands out as a true superfood 
                  that has stood the test of time. From boosting your immunity to improving your skin and hair health, 
                ...
                <ul className="space-y-4 text-gray-700">
                  {blog.benefits.map((benefit, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      <span className="text-[#d89a7e] font-bold text-xl mt-1">✓</span>
            ...
            <div className="mt-12 bg-green-50 rounded-2xl p-8 border border-green-100">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-bold text-lg text-gray-900 mb-3">Vitamins & Minerals</h4>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex justify-between">
                      <span>Vitamin C</span>
                      <span className="font-semibold text-green-700">Very High</span>
                    </li>
                    <li className="flex justify-between">
                      <span>Iron</span>
                ...
                <div>
                  <h4 className="font-bold text-lg text-gray-900 mb-3">Health Properties</h4>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex justify-between">
            ...
            <div className="mt-12 bg-gradient-to-r from-[#d89a7e] to-[#a75c22] rounded-2xl p-8 text-white text-center">
              <h3 className="text-2xl font-bold mb-4">Ready to Experience Amla Benefits?</h3>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {dummyBlogs
              ...
              .map((relatedBlog) => (
                <motion.div
                  key={relatedBlog.id}
                  onClick={() => navigate(`/blog/${relatedBlog.id}`, { state: { blog: relatedBlog } })}
