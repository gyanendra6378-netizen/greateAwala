...
const banner = "https://ik.imagekit.io/lnl0n5gl6/assets/banner-5.png";
  ...
  return (
    <div className="bg-[#faf9f6]">
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <h2 className="text-2xl font-bold mb-6 text-[#a75c22]">
          Our Bestsellers
        </h2>
      ...
      <section className="bg-[#f5f1e9] py-12 text-center">
        <h2 className="text-2xl font-bold mb-4">
          Stay Updated with Greate Awala
        </h2>
