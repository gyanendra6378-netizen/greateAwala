...
const imgJuice = "https://ik.imagekit.io/lnl0n5gl6/assets/juices.png";
const imgCandy = "https://ik.imagekit.io/lnl0n5gl6/assets/driy-1.jpg";
const imgPickle = "https://ik.imagekit.io/lnl0n5gl6/assets/tree-4.png";
const imgPowder = "https://ik.imagekit.io/lnl0n5gl6/assets/hair-1.png";
const heroBg = "https://ik.imagekit.io/lnl0n5gl6/assets/banner-5.png";
...
export interface Product {
  ...
  reviews: number;
  rating: number;
  category: "Juice" | "Snacks" | "Pickle" | "Powder";
}
...
type SortOption = "default" | "price-low" | "price-high" | "rating" | "discount";
...
export default function Products() {
  ...
  const [selectedCategory, setSelectedCategory] =
    useState<"All" | Product["category"]>("All");
  ...
  const handleAddToCart = (product: Product, e: React.MouseEvent) => {
    ...
    const cartItem: CartItem = {
      id: product.id,
      price: product.price,
      quantity: 0, // will be overridden by addToCart's quantity argument
      name: product.name,
      image: product.image,
              ...
              <ul className="space-y-2">
                {categories.map((cat) => (
                  <li
                    ...
                    className={`cursor-pointer  text-sm px-2 py-2 rounded-md ${
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 bg-white p-4 rounded-xl shadow">
              <p className="text-gray-600 font-medium">
                Showing{" "}
                <span className="text-[#d97f1f] font-bold">
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="col-span-3 text-center py-20 flex flex-col items-center gap-4">
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      {Array.from({ length: quickViewProduct.rating }).map(
                        (_, i) => (
                          <Star
                            key={i}
                            size={16}
                  ...
                  <div className="flex items-center gap-3">
                    <p className="text-3xl font-bold text-[#d97f1f]">
                    ...
                    <button
                      onClick={() =>
                        navigate(`/product/${quickViewProduct.id}`, {
                          state: { product: quickViewProduct },
                        })
                      }
                  ...
                  <div className="pt-4 border-t space-y-2 text-sm">
                    <p className="flex items-center gap-2">
                      <Truck size={16} className="text-green-600" /> Free
                      shipping on orders above ₹500
                    </p>
                    <p className="flex items-center gap-2">
                      <Shield size={16} className="text-blue-600" /> 100% secure
                      payment
                    </p>
                  </div>
                </div>
