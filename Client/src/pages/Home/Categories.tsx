const lifestyle = "https://ik.imagekit.io/lnl0n5gl6/assets/banner-1.png";
const tree = "https://ik.imagekit.io/lnl0n5gl6/assets/tree-1.png";
const sweet = "https://ik.imagekit.io/lnl0n5gl6/assets/oli-1.png";
const juice = "https://ik.imagekit.io/lnl0n5gl6/assets/drop-1.png";
    ...
    <section className="bg-[#fef8f4] py-14">
      <div className="text-center mb-10 px-4">
        ...
        <p className="text-sm text-gray-600 max-w-2xl mx-auto">
          Discover the best of Greate Awala – from fresh hand-picked Amla
          fruits to delicious sweets, juices, and natural products for a
          healthier lifestyle.
        </p>
      </div>
