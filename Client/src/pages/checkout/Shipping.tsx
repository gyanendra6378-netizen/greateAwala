...
type ShippingId = (typeof methods)[number]["id"];

interface ShippingProps {
  selected: ShippingId;
  setSelected: Dispatch<SetStateAction<ShippingId>>;
}

export default function Shipping({ selected, setSelected }: ShippingProps) {
  return (
