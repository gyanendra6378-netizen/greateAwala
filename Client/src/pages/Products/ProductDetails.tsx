...
import { productsData, type Product } from "./Products";
...
export default function ProductDetails() {
  ...
  if (!product) {
    return (
      <h2 className="text-center text-red-600 pt-20">Product not found</h2>
    );
  }
  ...
  const toCartItem = (p: Product): CartItem => ({
    id: p.id,
    price: p.price,
    quantity: 0, // overridden by addToCart's quantity argument
    name: p.name,
    image: p.image,
    category: p.category,
      ...
      <div className="pt-20 pb-16 px-4 md:px-10 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600 mb-8">
            <span
              className="cursor-pointer hover:text-[#d97f1f]"
              onClick={() => navigate("/")}
            >
              Home
            </span>
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="grid md:grid-cols-2 gap-8 p-6 md:p-10">
              ...
              <div className="space-y-6">
                ...
                {/* Price */}
                <div className="flex items-center gap-4">
                  <span className="text-4xl font-bold text-[#d97f1f]">
                    ₹{product.price}
                  </span>
              ...
              <div className="px-8 py-4 space-y-6">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Experience the natural goodness of our premium Amla
                    products. Made with 100% natural ingredients, this product
                    is carefully crafted to provide you with the best health
                    benefits. Our Amla products are sourced from trusted farms
                    and processed using traditional methods to preserve maximum
                    nutrients.
                  </p>
                </div>
                <div>
