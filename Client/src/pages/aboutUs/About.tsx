...
const img1 = "https://ik.imagekit.io/lnl0n5gl6/public/bg-1.png";

declare global {
  interface Window {
    __lenis?: Lenis;
    __lenisCreatedBy?: boolean;
  }
}
...
const About = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (window.__lenisCreatedBy && window.__lenis) {
  ...
  return (
    <div>
      ...
      {/* Hero Section */}
      <section
        className="relative  h-[300px] md:h-[500px] bg-cover bg-center flex items-center justify-center text-white"
      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="max-w-2xl mx-auto text-sm md:text-base text-gray-200">
            Learn more about our mission to bring the pure power of Amla to
            every home with natural, chemical-free wellness products.
          </p>
          <div className="mt-4 text-xs md:text-sm text-gray-300">
            <span className="text-[#cc8a51]">Home</span> &nbsp;&gt;&nbsp;{" "}
            <span>About</span>
          </div>
        </div>
      </section>
